...
<div class="hero min-h-screen bg-primary">
    <div class="flex-col justify-center hero-content lg:flex-row">
        <div class="text-center lg:text-left">
            ...
            <p class="mb-5">
                Rebonjour. Connectez-vous pour entrer dans votre réseau social.
            </p>
        </div> 
        <div class="card flex-shrink-0 w-full max-w-sm shadow-xl bg-base-100">
            <div class="card-body">
                <div class="form-control">
                    ...
                    <input type="text" placeholder="Adresse e-mail :" class="input input-bordered">
                </div> 
                <div class="form-control">
                    <label class="label">
                        <span class="label-text"></span>
                ...
                <div >
                    ...
                    <a class="btn btn-info btn-block">
                        <router-link to="/signup"> Créer un nouveau compte</router-link>
                    </a> 
                </div>
            </div>
        </div>
